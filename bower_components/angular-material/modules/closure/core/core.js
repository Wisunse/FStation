...
MdAutofocusDirective['$inject'] = ["$parse"];angular.module('dialog.core')
...
mdMediaFactory['$inject'] = ["$mdConstant", "$rootScope", "$window"];angular.module('dialog.core')
 ...
 * there are multiple dialog apps on the same page, each app
...
function attachToDocument( $mdGesture, $$MdGestureHandler ) {
  ...
  if (!isInitialized && $mdGesture.isHijackingClicks ) {
     ...
     * click events, and add a flag to events sent by dialog so we know not to prevent those.
     *
 ...
 * click as with `$dialog` correctly, but not the second input click.
 *
 ...
 * Used internally in dialog design for elements that appear on screen temporarily.
...
(function() {
   ...
   *
   * <link rel="stylesheet" href="angular-dialog.min.css">
   * <link rel="stylesheet" href="angular-dialog.layout.css">
   *
   * <body md-layout-css>
   *  ...
   * </body>
...
angular.module('material.core.meta', [])
   ...
   * @module dialog.core.componentRegistry
   *
   */
 ...
 * `palette` - Can be any one of the basic dialog design palettes, extended defined palettes and 'primary',
 ...
 *       palette: 'accent', // Default is 'primary', any basic dialog palette and extended palettes are available
 ...
 *
 * <link rel="stylesheet" href="angular-dialog.min.css">
 * <link rel="stylesheet" href="angular-dialog.themes.css">
 *
